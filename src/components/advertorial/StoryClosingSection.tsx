    ...
    <section className="py-10">
      <div className="container-article">
        <div className="salmon-box">
          <p className="text-lg md:text-xl font-serif text-primary mb-4">
            Hasta que descubrí algo que me cambió la vida:
          </p>
          
          <p className="text-2xl md:text-3xl font-serif font-semibold text-primary mb-6">
            No me había perdido.<br />
            Me había apagado para sobrevivir.
          </p>
          
          <div className="space-y-4 body-text text-foreground/85">
            <p>
